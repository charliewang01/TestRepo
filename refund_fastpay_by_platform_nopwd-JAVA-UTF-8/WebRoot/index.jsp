...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝即时到账批量退款无密接口快速通道</span>
		</div>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<span>必填，每进行一次即时到账批量退款，都需要提供一个批次号，必须保证唯一性</span>
					</dd>
					<dt>退款请求时间：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDrefund_date" />
						<span>必填，格式为：yyyy-MM-dd hh:mm:ss</span>
					</dd>
					<dt>退款总笔数：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDbatch_num" />
						<span>必填，即参数detail_data的值中，“#”字符出现的数量加1，最大支持1000笔（即“#”字符出现的最大数量999个）</span>
					</dd>
					<dt>单笔数据集：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDdetail_data" />
						<span>必填，格式详见“4.3 单笔数据集参数说明”</span>
					</dd>
                    <dt></dt>
                    <dd>
